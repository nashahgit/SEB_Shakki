			...
			<div class="modal-dialog" style="position:absolute;z-index: 1000;text-align:center;margin-top:100px;margin-left:25%;">
			    ...
			    <div class="modal-content">
			    	...
			    	<div class="modal-footer">
			          	<a href="/SEB_Shakki/jobs/admin/post-edit.php"><button type="button" class="btn btn-default" data-dismiss="modal">Add another Job</button></a>
			        </div>
			    </div>
		    </div>
		  ...
		  ';
			...
			echo '<div class="modal-dialog" style="position:absolute;z-index: 1000;text-align:center;margin-top:100px;margin-left:25%;">
			    ...
			    <div class="modal-content">
			    	...
			    	<div class="modal-footer">
			          	<a href="/SEB_Shakki/jobs/admin/post-edit.php"><button type="button" class="btn btn-default" data-dismiss="modal">Try again</button></a>
			        </div>
			    </div>
		    </div>
